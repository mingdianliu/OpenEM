...
// P41 cleanup kernel: **mechanically generated**, do not hand-edit; regenerate after changing
// yee.cu. The arithmetic is word for word that of update_e_lut, only launched over an index table.
...
extern "C" __global__ void update_e_lut_edge(
    ...
    const int* __restrict__ eidx, const int n_edge)
{
